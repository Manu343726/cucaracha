...
func (t *TraceFormatter) FormatSourceLocation(loc *mc.SourceLocation, srcLine string) {
...
func (t *TraceFormatter) formatSourceLocationPlain(loc *mc.SourceLocation, srcLine string) {
	if loc == nil || !loc.IsValid() {
		return
	}
...
func (t *TraceFormatter) formatSourceLocationColored(loc *mc.SourceLocation, srcLine string) {
	if loc == nil || !loc.IsValid() {
		return
	}
