...
`
	...
	t.Run("Functions", func(t *testing.T) {
		...
		getFuncInstructions := func(allInstructions []program.Instruction, fn program.Function) []program.Instruction {
	...
	t.Run("Labels", func(t *testing.T) {
		...
		labelMap := make(map[string]program.Label)
		for _, lbl := range labels {
	...
	t.Run("Globals", func(t *testing.T) {
		...
		// Type is correct
		assert.Equal(t, program.GlobalObject, arrGlobal.Type, "global type should be GlobalObject")
	...
	t.Run("Instructions", func(t *testing.T) {
		...
		for i, expected := range expectedInstructions {
			...
			for j, expectedSym := range expected.Symbols {
				...
				assert.Equal(t, program.SymbolKindUnknown, inst.Symbols[j].Kind(),
